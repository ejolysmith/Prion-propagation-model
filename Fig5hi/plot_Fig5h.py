...
loss event, and plots the average of absolute partititioning error relative to loss. 
...
plt.plot(divs, abs_part_error, linewidth=6, color = "darkorange")
plt.xlabel("Divisions relative to the loss", fontsize=25)
plt.ylabel("Absolute partitioning error", fontsize=25)
