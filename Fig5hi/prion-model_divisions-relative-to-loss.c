...
main(  )
{
    ...
    FILE *ff = fopen("prion-simulation-data-model-divisions-relative-to-loss.txt", "w");
    ...
    int N_parameters = 1;
	int N_sims = 10000   ; //Number of times to run the gillespie simulation
	int sim = 0;
	...
	for(sim = 0; sim<1000; sim++)
		...
		for (i = 0; i < N_steps - 1; i++)
			{	
                ...
                random_number = (ran1(&seed)) ;
				t = 0;
				t = - log(random_number)/rate_total;
