...
double beta_x = 0; //Individual prion degradation constant
double beta_y = 0; //aggregate degradation constant
...
main( int argc, char *argv[] )
{
    ...
    sprintf(str, "prion-data-model-6-tloss-L-10-v%d.txt" ,name_id);
    double Vscale = 1;
    FILE *ff = fopen( str, "w");
