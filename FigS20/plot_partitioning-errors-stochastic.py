...
plt.plot(divs, part_error1, linewidth=6, color = 'b',label='Large fluctuations')
plt.plot(divs, part_error2, linewidth=6, color = 'r',label='Moderate fluctuations')
plt.plot(divs, part_error3, linewidth=6, color = 'g',label='Small fluctuations')
...
plt.savefig("fig-part-stochastic.pdf")
