"""
Generates bottom right plot in FigS22
...
c1 = path + "prion-simulation-data-model-6-divisions-relative-to-loss-seed-noisy.txt"
...
plt.plot(divs, abs_part_error1, linewidth=6, color = 'b',label='noisy')
plt.plot(divs, abs_part_error2, linewidth=6, color = 'r',label='const')
...
plt.ylabel("Absolute partitioning error", fontsize=16)
...
plt.savefig("fig-abs-part-random-seed.pdf")
