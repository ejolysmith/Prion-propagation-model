...
main( int argc, char *argv[] )
{
    ...
    sprintf(str, "prion-data-model-6-time-rel-init-v%d.txt" ,name_id);
    FILE *ff = fopen( str, "w");
                ...
                for (i = 0; i<max_aggregate_size; i++) //aggregate initial condition
                    ...
                    else
                    {
                        ...
                        if (t_tot > wait_time && Y_tot > 0)
                        {
                            ...
                            fprintf(ff, "%lf %lf %d \n", ((double)(fluorescence))/Volume    ,  t_tot , is_it_loss );
