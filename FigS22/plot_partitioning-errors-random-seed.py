...
plt.plot(divs, part_error1, linewidth=6, color = 'b',label='noisy')
plt.plot(divs, part_error2, linewidth=6, color = 'r',label='const')
...
plt.savefig("fig-part-random-seed.pdf")
