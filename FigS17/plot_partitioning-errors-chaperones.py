...
plt.plot(divs, part_error1, linewidth=6, color = 'b',label='Average chaperone abundance = 1')
plt.plot(divs, part_error2, linewidth=6, color = 'r',label='Average chaperone abundance = 10')
...
plt.savefig("fig-partitioning-errors-chaperones.pdf")
