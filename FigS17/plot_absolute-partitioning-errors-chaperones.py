...
c1 = path + "prion-simulation-data-model-6-divisions-relative-to-loss-1.txt"
c2 = path + "prion-simulation-data-model-6-divisions-relative-to-loss-10.txt"
c3 = path + "prion-simulation-data-model-6-divisions-relative-to-loss-100.txt"
...
plt.plot(divs, abs_part_error1, linewidth=6, color = 'b',label='Average chaperone abundance = 1')
plt.plot(divs,  abs_part_error2, linewidth=6, color = 'r',label='Average chaperone abundance = 10')
plt.plot(divs,  abs_part_error3, linewidth=6, color = 'k',label='Average chaperone abundance = 100')
...
plt.savefig("fig-absolute-partitioning-errors-chaperones.pdf")
