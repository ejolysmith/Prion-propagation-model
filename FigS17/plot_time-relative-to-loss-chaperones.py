...
c1 = path + "prion-data-model-6-time-rel-1-v1-part1.txt"
data = np.loadtxt(c1)
for i in range(2,21):
    print(i)
    c1 = path + "prion-data-model-6-time-rel-1-v1-part" + str(i) + ".txt"
...
path = 'data_time-rel-to-loss/'
c1 = path + "prion-data-model-6-time-rel-10-v1-part1.txt"
data = np.loadtxt(c1)
for i in range(2,21):
    print(i)
    c1 = path + "prion-data-model-6-time-rel-10-v1-part" + str(i) + ".txt"
    data = np.concatenate((data, np.loadtxt(c1)))
...
time_bins2 = np.linspace(-400, 10, number_of_bins)
med_bins2 = []
...
path = 'data_time-rel-to-loss/'
c1 = path + "prion-data-model-6-time-rel-100-v1-part1.txt"
data = np.loadtxt(c1)
for i in range(2,21):
    print(i)
    c1 = path + "prion-data-model-6-time-rel-100-v1-part" + str(i) + ".txt"
    data = np.concatenate((data, np.loadtxt(c1)))
...
plt.savefig("fig-time-relative-to-loss-chaperones.pdf")
