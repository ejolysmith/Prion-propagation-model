...
c1 = path + "prion-simulation-data-model-6-divisions-relative-to-loss-seed-slow-stable.txt"
...
plt.plot(divs, abs_part_error1, linewidth=6, color = 'b',label='pulse')
#plt.plot(divs, abs_part_error2, linewidth=6, color = 'r',label='no')
...
plt.savefig("fig-abs-part-stable.pdf")
